...
➔ ここまで進めると、イベント次第で最初のダンジョンを踏破できるようになります。
...
- **報酬システムの拡張**:
  ...
  獲得したポモカウンターに応じて報酬を受け取れる「クエスト機能」を実装し、全滅時でもゲーム上のリターンが得られるようにする
...
* **冒険出発・進行**: 冒険時間（25分・60分・90分）を設定して開始
